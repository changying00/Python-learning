...
if __name__ == "__main__":
    ...
    # 创建一个 售票窗口
    window = TicketWindow("商丘站  A 窗口", tickets, lock)

    # 模拟 售票
    window.start()

    # 创建一个 售票窗口
    window2 = TicketWindow("商丘站  B 窗口", tickets, lock)
    # 模拟 售票
    window2.start()

    # 创建一个 售票窗口
    window3 = TicketWindow("商丘站  C 窗口", tickets, lock)
    # 模拟 售票
    window3.start()


    # 创建一个 售票窗口
    window4 = TicketWindow("商丘站  D 窗口", tickets, lock)
    # 模拟 售票
    window4.start()


    # 创建一个 售票窗口
    window5 = TicketWindow("商丘站  E 窗口", tickets, lock)
    # 模拟 售票
    window5.start()
