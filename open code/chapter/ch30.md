...
> 1 4 9 16 25                   # Runs __iter__, then __next__
> ```
>
...
> $ python3
> >>> from squares_yield import Squares
> >>> S = Squares(1, 5)            # Using the __iter__/yield Squares
> >>> I = iter(S)
> >>> next(I); next(I)
> 1
> 4
...
> 2                                # But not when instance is in a list!
> 3
> >>> print(objs)
