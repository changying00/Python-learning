...
> ```
> >>> L = ['code', 'hack']
> >>> [L, 2, 3, L]                           # Normal assignments nest items
...
> ```
> >>> L = ['hack', 'more', 'Py', 'code']
> >>> L[0:1] = []                           # Delete via slice assignment
> >>> L
> ['more', 'Py', 'code']
> >>> L[1:] = []                            # Delete all but first
> >>> L
> ['more']
> >>> L[0] = []                             # Replace item, don't delete!
> >>> L
> [[]]
> ```
>
...
> None
> >>> D.get('code', 4)                      # With a passed-in default
> 4
> ```
>
