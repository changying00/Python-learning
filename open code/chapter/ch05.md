...
> **Integer and floating-point literals（整数与浮点字面量）**
>
...
> **Hexadecimal, octal, and binary literals（十六、八、二进制字面量）**
>
...
> **Coding other numeric types（编写其他数字类型）**
>
...
>
> Equality tests do work on mixed types (e.g., a string is never equal to any integer), but magnitude comparisons do not.
...
> **DISPLAY FORMATS: STR AND REPR（显示格式：str 与 repr）**
>
...
> - `X // Y` — Called **floor** division, this always truncates fractional remainders down to their floor, regardless of types, and its result type depends on the types of its operands.
> - `X % Y` — Called **modulus**, this returns a division's remainder, with a result type that varies per operand types. This also does formatting when used on strings, per Chapter 7.
>
...
> ```
>
> **Floor versus truncation（地板还是截断）**
>
...
>
> **Setting decimal precision（设置 Decimal 精度）**
>
...
> ```
>
> **Numeric accuracy in fractions and decimals（Fraction 与 Decimal 的数值精度）**
>
...
> >>> S.add((1, 2, 3))
> >>> S
> {1.23, (1, 2, 3)}       # No list or dict; tuple, str, numbers OK
