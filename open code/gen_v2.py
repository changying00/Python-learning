...
def find_heading_lines(text):
    ...
    for i, line in enumerate(lines):
        ...
        if i > 0 and not lines[i-1].strip():
            if s[0].isupper() and not s.startswith(">>>") and not s.startswith("..."):
                if not any(s.startswith(w) for w in ["In ", "The ", "This ", "That ", "These ", "Those ", "For ", "With ", "By ", "As ", "Like ", "Such ", "All ", "Both ", "Each ", "Every ", "Some ", "No ", "Not ", "But ", "And ", "Or ", "If ", "When ", "While ", "Because ", "Since ", "Although ", "However ", "Therefore ", "Moreover ", "Furthermore ", "Nevertheless ", "Additionally ", "Instead ", "Otherwise ", "Thus ", "Hence ", "So ", "Then ", "Now ", "Also ", "Still ", "Already ", "Always ", "Never ", "Here ", "There ", "Where ", "Why ", "How ", "What ", "Which ", "Who ", "Whom ", "Whose ", "Whether ", "Unless ", "Until ", "Before ", "After ", "Between ", "Among ", "Through ", "During ", "Without ", "Within ", "Against ", "Along ", "Around ", "Behind ", "Below ", "Beyond ", "Inside ", "Outside ", "Across ", "Down ", "Up ", "Out ", "Off ", "Over ", "Under ", "Again ", "Once ", "Twice ", "Away ", "Back ", "Forward ", "Together ", "Apart ", "Aside "]):
                    headings.append((i, s))
    return headings, lines


def split_text_by_headings(text, major_headings):
    lines = text.split("\n")
    sections = []
    current_start = 0
    current_title = "Chapter Introduction"

    heading_positions = {h[0]: h[1] for h in major_headings}
    ...
    for i, line in enumerate(lines):
        if i in heading_positions:
            ...
            current_title = heading_positions[i]
            current_start = i
...
def deep_understand(title, body):
    ...
    elif "attribute" in t or "method" in t or "getattr" in t or "getattribute" in t or "setattr" in t or "delattr" in t:
        return [
...
def process_chapter(num):
    ...
    headings, lines = find_heading_lines(text)
